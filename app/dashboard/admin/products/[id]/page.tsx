...
export default function EditProduct() {
  ...
  useEffect(() => {
    ...
    fetch("/api/brands")
      .then((r) => r.json())
      .then((data) => setBrands((data.brands || []).map((b: any) => ({ id: b.slug, name: b.name, slug: b.slug }))));
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const payload = {
        ...
        specs: form.specs.filter((s) => s.specName && s.specValue),
        tags: form.tags,
      };
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          {!isNew && (
            <button type="button" onClick={handleDelete} className="btn-ghost text-red-400 flex items-center gap-2 text-sm">
