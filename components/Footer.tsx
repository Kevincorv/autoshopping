    ...
    <Fragment>
      ...
      <div className="border-t border-neutral-800 py-4 text-center text-xs text-neutral-500">
        ...
        <p className="mt-1" style={{ fontSize: 12, opacity: 0.6 }}>
          <a href="https://www.instagram.com/kevincorv/" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-300 transition-colors">Desarrollado por KRC Technologies - Software · Web · Digital Solutions</a>
        </p>
      </div>
    </footer>
    </Fragment>
